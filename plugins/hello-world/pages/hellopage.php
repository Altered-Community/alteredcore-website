...
$txt = [
    'en' => [
        ...
        'assets_desc'   => 'The image below is served from <code>assets/no_rules.png</code> inside this plugin\'s directory. The button is wired by <code>assets/hello.js</code>, loaded automatically via <code>plugin.json</code>.',
    ...
    'fr' => [
        ...
        'assets_desc'   => 'L\'image ci-dessous est servie depuis <code>assets/no_rules.png</code> dans le répertoire du plugin. Le bouton est câblé par <code>assets/hello.js</code>, chargé automatiquement via <code>plugin.json</code>.',
