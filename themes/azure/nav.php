...
<header class="az-site-header site-header">

    <!-- Row 1: brand on the left, controls (toggle + lang + user) on the right, burger far right (mobile only) -->
    <div class="az-topbar">
        <div class="az-topbar-inner">
